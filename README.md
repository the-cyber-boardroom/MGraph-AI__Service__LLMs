...
[![Current Release](https://img.shields.io/badge/release-v0.6.10-blue)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__LLMs/releases)
...
To create a new service from this template, see [Creating Services from MGraph-AI__Service__LLMs](docs/dev/non-functional-requirements/version-1_0_0/README.md).
