...
export class AnalysisPanel extends HTMLElement {
    ...
    updateQuestions(questions) {
        ...
        if (!this.isGlobalView) {
            ...
            // v1.1: Add click handlers for add question buttons
            section.querySelectorAll('.add-question-btn').forEach((btn) => {
                btn.addEventListener('click', (e) => {
                    ...
                    // NEW: Add as system message instead of just to input
                    this.dispatchEvent(new CustomEvent('question-added-as-message', {
                        detail: {
                            question: question,
...
- IMPORTANT: Answer the EXACT question being asked, not a different question from earlier
- For yes/no questions, start with yes/no then elaborate
- Stay consistent with previous answers in the conversation

For this specific question about "${question}", provide a direct, relevant answer.`;
