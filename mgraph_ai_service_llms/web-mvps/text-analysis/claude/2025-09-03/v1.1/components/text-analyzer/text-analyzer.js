// mgraph_ai_service_llms/web-mvps/text-analysis/v1.0/components/text-analyzer/text-analyzer.js

import { APIClient } from '../../../../2025-08-22/v1.0/services/api-client.js';
...
export class TextAnalyzer extends HTMLElement {
    ...
    setupEventListeners() {
        ...
        this.analysisPanel.addEventListener('answer-generated', (e) => {
            // FIXED: Question from system, answer from user
            this.chatPanel.addMessage(e.detail.question, 'system');                 // Question is from system
            this.chatPanel.addMessage(e.detail.answer, 'user', e.detail.cacheId);   // Answer is from user/persona
            this.handleAnalyzeText(e.detail.answer);                                // Analyze the user's answer
        });
