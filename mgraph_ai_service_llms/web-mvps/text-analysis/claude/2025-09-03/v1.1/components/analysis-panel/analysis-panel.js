...
export class AnalysisPanel extends HTMLElement {
    ...
    const systemPrompt = `You are roleplaying as a business user/persona who has requested text analysis. Based on the context provided, answer the following question from THEIR perspective as if you are the user providing information about your organization or situation.
