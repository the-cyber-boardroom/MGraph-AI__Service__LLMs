...
from mgraph_ai_service_llms.platforms.open_router.schemas.models.Schema__Open_Router__Model__Per_Request_Limits import Schema__Open_Router__Model__Per_Request_Limits
...
class Schema__Open_Router__Model(Type_Safe):
    ...
    hugging_face_id      : Safe_Str__Open_Router__Model_ID     = None           # Hugging Face model ID (may be empty)
    name                 : Safe_Str__Open_Router__Model_Name                    # Human-readable model name
    created              : Safe_Int                                             # Unix timestamp of creation
    description          : Safe_Str__Open_Router__Description                                       # Detailed model description
    ...
    def json(self):
        ...
        json_data['pricing'] = self.pricing.json()
        return json_data