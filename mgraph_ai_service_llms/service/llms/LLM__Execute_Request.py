from mgraph_db.providers.llms.utils.API__LLM__Open_Router               import API__LLM__Open_Router
...
class LLM__Execute_Request(Type_Safe):
    ...
    def extract_facts(self, text_content, model_to_use:Schema__Open_Router__Supported_Models = LLM__MODEL_TO_USE__DEFAULT):
        ...
        facts               = self.prompt_extract_facts.process_llm_response(llm_response)
