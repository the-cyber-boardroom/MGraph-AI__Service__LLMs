...
class test_Execute_Request(TestCase):
    ...
    def test_llm_request(self):
        with self.prompt_extract_facts as _:
            llm_request = self.prompt_extract_facts.llm_request(text_content=self.text_content, model_to_use=self.model_to_use)
            ...
            with llm_request.request_data.messages[1] as _:
                ...
                assert self.text_content in _.content
    ...
    def test_extract_facts(self):
        ...
        with self.llm_execute_request as _:
            ...
            result = _.extract_facts(text_content=self.text_content, model_to_use=self.model_to_use)
            assert list_set(result) == ['cache_id', 'data', 'model']

    def test_extract_facts__request_hash(self):
